...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var incrementaPorUno = array.map((elemento) => elemento +1);
   return incrementaPorUno;
}
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   let resultado = 0;
   arrayOfNums.forEach((element)=> {resultado += element}); 
   return resultado;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   for(var i = 0; i < resultadosTest.length; i++) {
      i; promedioNotas += resultadosTest[i];
      largo = largo +1;
   }
   var resultado = promedioNotas / largo;
   return resultado;
}
